        ...
        <Tabs defaultValue="twitter" className="w-full">
          ...
          <TabsContent value="twitter">
            <div className="space-y-4">
              <div
                ref={previewRefs.twitter}
                className="bg-white p-6 rounded-lg border shadow-sm"
              >
                <h3 className="font-bold text-xl mb-2">{truncateText(title, 70)}</h3>
          ...
          <TabsContent value="facebook">
            <div className="space-y-4">
              <div
                ...
                className="bg-white p-6 rounded-lg border shadow-sm"
              >
                <h3 className="font-bold text-2xl mb-3">{truncateText(title, 100)}</h3>
          ...
          <TabsContent value="linkedin">
            <div className="space-y-4">
              <div
                ...
                className="bg-white p-6 rounded-lg border shadow-sm"
              >
                <h3 className="font-bold text-2xl mb-3">{truncateText(title, 120)}</h3>
